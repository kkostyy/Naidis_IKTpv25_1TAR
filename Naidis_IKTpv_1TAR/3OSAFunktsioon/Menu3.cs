    ...
    public class Menu3
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("1.  Teooria: while (matkajad)");
                Console.WriteLine("2.  Teooria: for (matkajad)");
                Console.WriteLine("3.  Teooria: do-while (matkajad)");
                Console.WriteLine("4.  Teooria: Isik klass + List");
                Console.WriteLine("5.  Teooria: massiivid (4 tsüklit)");
                Console.WriteLine("6.  Teooria: Tuple näide");
                Console.WriteLine("7.  Ülesanne 1:  Juhuslike arvude ruudud");
                Console.WriteLine("8.  Ülesanne 2:  Viie arvu analüüs (Tuple)");
                Console.WriteLine("9.  Ülesanne 3:  Nimed ja vanused (statistika)");
                Console.WriteLine("10. Ülesanne 4:  Osta elevant ära!");
                Console.WriteLine("11. Ülesanne 5:  Arvamise mäng");
                Console.WriteLine("12. Ülesanne 6:  Suurim neljakohaline arv");
                Console.WriteLine("13. Ülesanne 7:  Korrutustabel");
                Console.WriteLine("14. Ülesanne 8:  Opilastega mängimine");
                Console.WriteLine("15. Ülesanne 9:  Arvude ruudud");
                Console.WriteLine("16. Ülesanne 10: Positiivsed ja negatiivsed");
                Console.WriteLine("17. Ülesanne 11: Keskmisest suuremad");
                Console.WriteLine("18. Ülesanne 12: Suurima arvu otsing");
                Console.WriteLine("19. Ülesanne 13: Paarisarvud ja paaritud");
                ...
                {
                    Console.Write("Minimaalne arv: ");
                    int min = int.Parse(Console.ReadLine());
                    Console.Write("Maksimaalne arv: ");
                    int max = int.Parse(Console.ReadLine());

                    int[] ruudud = OSA3ArvuTootlus.GenereeriRuudud(min, max);
                ...
                {
                    List<OSA3Inimene> inimesed = new List<OSA3Inimene>();
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        inimesed.Add(new OSA3Inimene(nimi, vanus));
                    }
                    var stat = OSA3Funktsioon.Statistika(inimesed);
                    Console.WriteLine("Summa:    " + stat.Item1);
                    Console.WriteLine("Keskmine: " + Math.Round(stat.Item2, 1));
                    Console.WriteLine("Vanim:    " + stat.Item3.Nimi + " (" + stat.Item3.Vanus + " a)");
                    Console.WriteLine("Noorim:   " + stat.Item4.Nimi + " (" + stat.Item4.Vanus + " a)");
                }
                else if (valik == "10")
                ...
                else if (valik == "13")
                {
                    ...
                    Console.Write("Kas soovid otsida korrutist? (jah/ei): ");
                ...
                else if (valik == "0")
                {
                    ...
                    Console.WriteLine("Palun vali 0-19");
            }
        }
    }
}
