    ...
    public class Menu5
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("7.  Ülesanne 2: Maakonnad ja pealinnad");
                Console.WriteLine("8.  Ülesanne 3: Opilased ja hinded");
                Console.WriteLine("9.  Ülesanne 4: Filmide kogu");
                Console.WriteLine("10. Ülesanne 5: Arvude statistika");
